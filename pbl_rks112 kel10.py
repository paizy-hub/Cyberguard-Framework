...
# Pastikan untuk menutup cursor dan koneksi setelah selesai digunakan
#GUI
class StartScreen:
...
class ToolsPage:
    ...
    def create_widgets(self):
        ...
        Button(self.frame, width=16, pady=7, text='Substitution Chiper', bg='#ff69b4', fg='white', cursor='hand2', border=0, command=self.open_substitution_cipher).place(x=147, y=140)
        Button(self.frame, width=14, pady=7, text='Back', bg='#ff69b4', fg='white', cursor='hand2', border=0, command=self.back_to_home).place(x=153, y=300)
